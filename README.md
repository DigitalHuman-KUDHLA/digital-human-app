...
> [!WARNING]
> こちらの方法は動作検証を行なっていません。「おそらくできるだろう」という状態です。
> 
> もしうまくいかなければ[@satsuki2200](https://github.com/satsuki2200)まで連絡お願いします

### 1. Node.jsのインストール
今回はHomebrewを使用してインストールします。
> [!NOTE]
> Node.jsのバージョン管理ツールを使用している方はそちらを使用してインストールしていただいて構いませんが、
> バージョン管理ツールを使用してNode.jsをインストールする方法は記載しません(割愛します)。
>
> 各自で調査してインストールをお願いします。
<br>
...
インストール後、PATHを通すよう求められた場合は、案内に従ってPATHを通してください。
